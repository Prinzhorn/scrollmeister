...
var _betterposition = require('./betterposition.js');

var _betterposition2 = _interopRequireDefault(_betterposition);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_scrollmeister2.default.defineBehavior('layout', _layout2.default);
...
},{"../scrollmeister.js":11,"./betterposition.js":2,"./layout.js":4,"./position.js":5}],4:[function(require,module,exports){
'use strict';
...
var LayoutBehavior = function () {
	_createClass(LayoutBehavior, null, [{
		key: 'schema',
		get: function get() {
			return {
				guides: {
  ...
  */
	...
	function LayoutBehavior(element, config) {
...
},{"./MeisterComponent.js":7}],7:[function(require,module,exports){
'use strict';
...
var ScrollMeisterComponent = function (_HTMLElement) {
	...
	function ScrollMeisterComponent() {
		...
		return _possibleConstructorReturn(this, (ScrollMeisterComponent.__proto__ || Object.getPrototypeOf(ScrollMeisterComponent)).call(this));
	}
...
},{"../scrollmeister.js":11}],8:[function(require,module,exports){
"use strict";
...
},{"./MeisterComponent.js":7}],9:[function(require,module,exports){
'use strict';

require('document-register-element');

var _ScrollMeisterComponent = require('./ScrollMeisterComponent.js');

var _ScrollMeisterComponent2 = _interopRequireDefault(_ScrollMeisterComponent);

var _ElementMeisterComponent = require('./ElementMeisterComponent.js');
...
},{"./ElementMeisterComponent.js":6,"./ScrollMeisterComponent.js":8,"document-register-element":1}],10:[function(require,module,exports){
"use strict";
...
},{"./behaviors":3,"./components":9,"./scrollmeister.js":11}],11:[function(require,module,exports){
"use strict";
...
var Scrollmeister = {
	...
	attachBehavior: function attachBehavior(element, name, config) {
		...
		if (element.hasOwnProperty(name)) {
				...
				try {
					for (var _iterator = Behavior.dependencies[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
						...
						if (!element.hasOwnProperty(dependency)) {
							...
							var behaviors = this.behaviorsWaitingForDependencies.get(element);
							behaviors.add(name);
							return;
						}
					}
			...
			if (this.behaviorsWaitingForDependencies.has(element)) {
				var _behaviors = this.behaviorsWaitingForDependencies.get(element);
				...
				try {
					for (var _iterator2 = _behaviors[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
